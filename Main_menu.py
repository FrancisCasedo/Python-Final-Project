...
def mainMenu():
    ...
    lblBank = tk.Label(root, text = "Bangko de Gago", width = 16, height = 4, font = ("Arial", 15))
    lblHeader = tk.Label(root, text = "Main Menu", width = 8, height = 4, font = ("Arial", 14))
    lblOption1 = tk.Label(frame, text = "Option 1", width = 8, height = 4, font = ("Arial", 14))
    btn1 = tk.Button(frame, width = 1, height = 0, font = ("Arial", 8))
    lblOption2 = tk.Label(frame2, text = "Option 1", width = 8, height = 4, font = ("Arial", 14))
    btn2 = tk.Button(frame2, width = 1, height = 0, font = ("Arial", 8))
    lblHeader = tk.Label(root, text = "Main Menu", width = 8, height = 4, font = ("Arial", 14))
    lblOption3 = tk.Label(frame3, text = "Option 1", width = 8, height = 4, font = ("Arial", 14))
    btn3 = tk.Button(frame3, width = 1, height = 0, font = ("Arial", 8))
    lblOption4 = tk.Label(frame4, text = "Option 1", width = 8, height = 4, font = ("Arial", 14))
    ...
    lblOption3.grid(row = 0, column = 1, padx = 170 , pady = 10)
